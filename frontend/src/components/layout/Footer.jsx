    ...
    >
      <div className="container">
        <div className="about">
          ...
          <p>
            <span>Email:</span>ishan@gmail.com
          </p>
          <p>
        ...
        <div className="news_letter">
          <div>
            ...
            <p>Get Our research Data and articles and offer via email</p>
          </div>
          <div>
      ...
      <div className="container">
        <div className="logo">LNCT <span> Research And DevelopMent</span></div>
        <div className="links">
